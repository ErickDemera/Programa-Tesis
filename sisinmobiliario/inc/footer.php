...
<footer class="py-4" style="background-color: #3692F2;">
    <div class="container">
        <div class="row">
            ...
            <p class="m-0 text-white"><strong>Contactenos:</strong></p>
                <p class="m-0 text-white">Direccion: Av. Los Monacos N° 179, Distrito Puña </p>
                <p class="m-0 text-white">Correo: <a href="mailto:info@tudominio.com" class="text-white">info@casagrande.com</a></p>
                <p class="m-0 text-white">Teléfono: <a href="tel:+123456789" class="text-white">+51 999 453 452</a></p>
            </div>
            <div class="col-md-4">
    ...
    <div class="col-md-12">
        ...
        <p class="m-0 text-center text-white">Desarrollado por: <a href="mailto:oretnom23@gmail.com" class="text-white">Tarea Completo</a></p>
    </div>
</div>
    </div>
</footer>
